...
const W3podsumowanie = function W3podsumowanie({ navigation }) {
   ...
   const [dxl3,setdxl3]=useState();
    ...
    const loaddane = async () =>{
        ...
        try{
          let wartosci = {};
          wartosci.dxl1 = await AsyncStorage.getItem("W3dxl1")
          wartosci.dxl2 = await AsyncStorage.getItem("W3dxl2")
          wartosci.dxl3 = await AsyncStorage.getItem("W3dxl3")
          wartosci.dxl4 = await AsyncStorage.getItem("W3dxl4")
          wartosci.dxl5 = await AsyncStorage.getItem("W3dxl5")
          ...
          wartosci.n1 = await AsyncStorage.getItem("W3n1")
          wartosci.n2 = await AsyncStorage.getItem("W3n2")
          wartosci.n3 = await AsyncStorage.getItem("W3n3")
          wartosci.n4 = await AsyncStorage.getItem("W3n4")
          wartosci.n5 = await AsyncStorage.getItem("W3n5")
          ...
          wartosci.ra4 = await AsyncStorage.getItem("W3ra4")
          wartosci.ra5 = await AsyncStorage.getItem("W3ra5")
          wartosci.ra6 = await AsyncStorage.getItem("W3ra6")
          wartosci.ra7 = await AsyncStorage.getItem("W3ra7")
          wartosci.ra8 = await AsyncStorage.getItem("W3ra8")
          wartosci.Tokarka = await AsyncStorage.getItem("W3Material")
          wartosci.MocTokarka = await AsyncStorage.getItem("W3narzedzie")
          wartosci.Material = await AsyncStorage.getItem("W3profilcyfrowy")
          wartosci.Narzedzia = await AsyncStorage.getItem("W3Dc")
          wartosci.Kr = await AsyncStorage.getItem("W3cieczobróbkowa")
          wartosci.Krsecond = await AsyncStorage.getItem("W3z")
    ...
    return (
        ...
        <Text style={styles.nazwy}>Dc : {Narzedzia}</Text>
       </View>
       <View style={styles.mniejszaprzerwa}></View>
             <View style={styles.textstyle}>
        
        <Text style={styles.nazwy}>z : {Krsecond}</Text>
        <Text style={styles.nazwy}>Ciecz obróbkowa : {Kr}</Text>
        </View>
        <View style={styles.mniejszaprzerwa}></View>
       ...
       <View style={styles.mniejszaprzerwa}></View>
          ...
          <View style={styles.mniejszaprzerwa}></View>
          <View><Text>n=1000*vc/pi*d</Text></View>
