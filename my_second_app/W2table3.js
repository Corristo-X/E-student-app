...
const W2table3 = function W2table3({ navigation }) {
 ...
 const [dxl3,setdxl3]=useState();
  ...
  const savedane = async()=>{
    try{
          ...
          await AsyncStorage.setItem("W2dxl1.3",dxl1);
          await AsyncStorage.setItem("W2dxl2.3",dxl2);
          await AsyncStorage.setItem("W2dxl3.3",dxl3);
          await AsyncStorage.setItem("W2dxl4.3",dxl4);
          await AsyncStorage.setItem("W2dxl5.3",dxl5);
          await AsyncStorage.setItem("W2dxl6.3",dxl6);
       
          
          await AsyncStorage.setItem("W2n1.3",n1);
          await AsyncStorage.setItem("W2n2.3",n2);
          await AsyncStorage.setItem("W2n3.3",n3);
          await AsyncStorage.setItem("W2n4.3",n4);
          await AsyncStorage.setItem("W2n5.3",n5);
          await AsyncStorage.setItem("W2n6.3",n6);
       

          await AsyncStorage.setItem("W2vc1.3",vc1);
          await AsyncStorage.setItem("W2vc2.3",vc2);
          await AsyncStorage.setItem("W2vc3.3",vc3);
          await AsyncStorage.setItem("W2vc4.3",vc4);
          await AsyncStorage.setItem("W2vc5.3",vc5);
          await AsyncStorage.setItem("W2vc6.3",vc6);
          //
         ...
         // await AsyncStorage.setItem("W2vc9",vc9);
          //await AsyncStorage.setItem("W2vc1.30",vc10);
        


      

          await AsyncStorage.setItem("W2re1.3",re1);
          await AsyncStorage.setItem("W2re2.3",re2);
          await AsyncStorage.setItem("W2re3.3",re3);
          await AsyncStorage.setItem("W2re4.3",re4);
          await AsyncStorage.setItem("W2re5.3",re5);
          await AsyncStorage.setItem("W2re6.3",re6);
     
          

          await AsyncStorage.setItem("W2ra1.3",ra1);
          await AsyncStorage.setItem("W2ra2.3",ra2);
          await AsyncStorage.setItem("W2ra3.3",ra3);
          await AsyncStorage.setItem("W2ra4.3",ra4);
          await AsyncStorage.setItem("W2ra5.3",ra5);
          await AsyncStorage.setItem("W2ra6.3",ra6);
  ...
  const loaddane = async () =>{
    try{
      let zmienne = {};
      zmienne.dxl1 = await AsyncStorage.getItem("W2dxl1.3")
      zmienne.dxl2 = await AsyncStorage.getItem("W2dxl2.3")
      zmienne.dxl3 = await AsyncStorage.getItem("W2dxl3.3")
      zmienne.dxl4 = await AsyncStorage.getItem("W2dxl4.3")
      zmienne.dxl5 = await AsyncStorage.getItem("W2dxl5.3")
      zmienne.dxl6 = await AsyncStorage.getItem("W2dxl6.3")
      zmienne.dxl7 = await AsyncStorage.getItem("W3dxl7")
      zmienne.dxl8 = await AsyncStorage.getItem("W3dxl8")

      zmienne.n1 = await AsyncStorage.getItem("W2n1.3")
      zmienne.n2 = await AsyncStorage.getItem("W2n2.3")
      zmienne.n3 = await AsyncStorage.getItem("W2n3.3")
      zmienne.n4 = await AsyncStorage.getItem("W2n4.3")
      zmienne.n5 = await AsyncStorage.getItem("W2n5.3")
      zmienne.n6 = await AsyncStorage.getItem("W2n6.3")
      zmienne.n7 = await AsyncStorage.getItem("W3n7")
      zmienne.n8 = await AsyncStorage.getItem("W3n8")

      zmienne.vc1 = await AsyncStorage.getItem("W2vc1.3")
      zmienne.vc2 = await AsyncStorage.getItem("W2vc2.3")
      zmienne.vc3 = await AsyncStorage.getItem("W2vc3.3")
      zmienne.vc4 = await AsyncStorage.getItem("W2vc4.3")
      zmienne.vc5 = await AsyncStorage.getItem("W2vc5.3")
      zmienne.vc6 = await AsyncStorage.getItem("W2vc6.3")
      zmienne.vc7 = await AsyncStorage.getItem("W2vc7")
      zmienne.vc8 = await AsyncStorage.getItem("W2vc8")

      zmienne.re1 = await AsyncStorage.getItem("W2re1.3")
      zmienne.re2 = await AsyncStorage.getItem("W2re2.3")
      zmienne.re3 = await AsyncStorage.getItem("W2re3.3")
      zmienne.re4 = await AsyncStorage.getItem("W2re4.3")
      zmienne.re5 = await AsyncStorage.getItem("W2re5.3")
      zmienne.re6 = await AsyncStorage.getItem("W2re6.3")
      zmienne.re7 = await AsyncStorage.getItem("W3re7")
      zmienne.re8 = await AsyncStorage.getItem("W3re8")

      zmienne.ra1 = await AsyncStorage.getItem("W2ra1.3")
      zmienne.ra2 = await AsyncStorage.getItem("W2ra2.3")
      zmienne.ra3 = await AsyncStorage.getItem("W2ra3.3")
      zmienne.ra4 = await AsyncStorage.getItem("W2ra4.3")
      zmienne.ra5 = await AsyncStorage.getItem("W2ra5.3")
      zmienne.ra6 = await AsyncStorage.getItem("W2ra6.3")
  ...
  const removedane = async()=>{
    ...
    try{
        await AsyncStorage.removeItem("W2dxl1.3")
        await AsyncStorage.removeItem("W2dxl2.3")
        await AsyncStorage.removeItem("W2dxl3.3")
        await AsyncStorage.removeItem("W2dxl4.3")
        await AsyncStorage.removeItem("W2dxl5.3")
        await AsyncStorage.removeItem("W2dxl6.3")
        await AsyncStorage.removeItem("W3dxl7")
        await AsyncStorage.removeItem("W3dxl8")

        await AsyncStorage.removeItem("W2n1.3")
        await AsyncStorage.removeItem("W2n2.3")
        await AsyncStorage.removeItem("W2n3.3")
        await AsyncStorage.removeItem("W2n4.3")
        await AsyncStorage.removeItem("W2n5.3")
        await AsyncStorage.removeItem("W2n6.3")
        await AsyncStorage.removeItem("W3n7")
        await AsyncStorage.removeItem("W3n8")

        await AsyncStorage.removeItem("W2vc1.3")
        await AsyncStorage.removeItem("W2vc2.3")
        await AsyncStorage.removeItem("W2vc3.3")
        await AsyncStorage.removeItem("W2vc4.3")
        await AsyncStorage.removeItem("W2vc5.3")
        await AsyncStorage.removeItem("W2vc6.3")
        await AsyncStorage.removeItem("W2vc7")
        await AsyncStorage.removeItem("W2vc8")
        
        await AsyncStorage.removeItem("W2re1.3")
        await AsyncStorage.removeItem("W2re2.3")
        await AsyncStorage.removeItem("W2re3.3")
        await AsyncStorage.removeItem("W2re4.3")
        await AsyncStorage.removeItem("W2re5.3")
        await AsyncStorage.removeItem("W2re6.3")
        await AsyncStorage.removeItem("W3re7")
        await AsyncStorage.removeItem("W3re8")

        await AsyncStorage.removeItem("W2ra1.3")
        await AsyncStorage.removeItem("W2ra2.3")
        await AsyncStorage.removeItem("W2ra3.3")
        await AsyncStorage.removeItem("W2ra4.3")
        await AsyncStorage.removeItem("W2ra5.3")
        await AsyncStorage.removeItem("W2ra6.3")
  ...
  if(isLoading==true){
    return (
      <ScrollView>
      <View>
        <View ><Text style={styles.boldx2}>Wiertło z krawędziami niesymetrycznymi : </Text></View>
